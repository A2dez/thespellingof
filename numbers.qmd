...
The 'w' is also present in Modern German *zwei* and all the Germanic languages \[\[PIC?\]\], but the root goes can be traced to the Indo-European root \*dwo-, which also gave us Latin *duo* and modern Itlalian *due*. The root weaves its way into English via several languages, including words beginning with 'bi', 'deu', 'di', 'du', 'tw' or 'zw'.

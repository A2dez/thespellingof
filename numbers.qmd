...
The spelling of English numbers is **about as bizarre and inconsistent** as it gets, from the 'silent' letter \<w\> in *two* to the unwritten /w/ sound at the start of *one*. \[\[add pic of IPA for one\]\] Things settle down a bit after the first pair of numerals but there remain no shortage of quirks in these ancient, high-frequency words, providing perfect conditions for fossilized oddities. I'm going to blast through the numerals from 1-20 and the round numbers after that, 30 - 90, 100, 1000, a million and a squillion. But *one* is so weird that I'm saving the first til last, and we'll kick of with *two*.

## Two

### Missing \[w\]

The 'missing' \[w\] sound in 'two' vanished as part of sound changes in earlier forms of English and similar process affected *sword, answer*, and, curiously, *who* and *whom*, which used to have a /hw/ cluster. Importantly, the /w/ sound survives in a buncha related words, most notably *twelve* and *twenty*, as we'll see below, but also in *twin* and *twice, betwixt* and *between*, and a roll call of other doubly, forky, splitting things such a *twilight*, blending day and night, *twine*, mixing two or more threads, and also *twist*, *twig* and *twill*. Mark also that these words all have \<e\> or \<i\> after the 'w', as the sound change didn't occur before front vowels. \[\[ reference / check \]\].

So how did the /w/ sound vanish? It seems frequency must have had an effect, and you can test this out by saying the word 'towards' a few dozen times in a row. First you'll notice the initial vowel vanishing ('twards') and then the 'w' will disappear, leaving you with 'tords'. \[\[INsert audio\]\] I've begun to notice lots of /w/ dropping in my own speech, most notably for the word *with*. Speaking quickly, I drop the /w/ in the common phrase "Breakfast with Tiffany" \[\[, or even "See ya next week"\]\].

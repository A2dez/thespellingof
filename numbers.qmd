...
The missing /w/ in 'two' vanished as part of sound changes in earlier forms of English and similar process affected *sword, answer*, and, bizarrely, *who*, which usd to have a /hw/ sound. However, the /w/ sound survives in a buncha related words, most notably *twelve* and *twenty*, as we'll see below, but also in *twin* and *twice, betwixt* and *between*, and a roll call of other doubly, forky, splitting things such a *twilight*, blending day and night, *twine*, mixing two or more threads, and also *twist*, *twig* and *twill*. Mark also that these words all have \<e\> or \<i\> after the 'w', as the sound change didnt occur before front vowels.
...
Incidentally, the writer Samuel Langhorne Clemens took his pseudonym, *Mark Twain*, from a boating term meaning to mark twain fathoms of depth, or twelve foot, and the name is as ridonc as the rapper Fifty Cent.

*\[\[ INSERT PIC of 50c euro / the rapper. \]\]*

The 'w' survives in Modern German *zwei* and all the Germanic languages \[\[PIC?\]\], but the root goes deeper and we see it in the Romance languages, including Latin *duo* and modern Italian *due*.

\[\[ INSERT PERSON ORDERING due cappuccini, ideally a pretentious knob \]\]

The sequence derives from Indo-European \*dwo-, and it weaves its way via several languages on the way to English words beginning with 'bi', 'deu', 'di', 'du', 'tw' or 'zw'.
